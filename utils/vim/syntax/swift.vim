...
syn keyword swiftFuncKeywordGeneral skipwhite skipempty nextgroup=swiftTypeParameters,swiftArgumentsRegion
      \ init
...
syn match swiftTypeName contained skipwhite skipempty nextgroup=swiftTypeParameters,swiftArgumentsRegion
      \ /\<[A-Za-z_][A-Za-z_0-9\.]*\>/
...
syn match swiftOperator +\.\@<!\.\.\.\@!\|[/=\-+*%<>!&|^~]\@<!\(/[/*]\@![/=\-+*%<>!&|^~]*\|*/\@![/=\-+*%<>!&|^~]*\|->\@![/=\-+*%<>!&|^~]*\|[=+%<>!&|^~][/=\-+*%<>!&|^~]*\)+ skipwhite skipempty nextgroup=swiftTypeParameters,swiftArgumentsRegion
syn match swiftOperator "\.\.[<.]" skipwhite skipempty nextgroup=swiftTypeParameters,swiftArgumentsRegion
